...
data = {
    'Player': ['Future Coder'],
    'Season': ['23/24'],
    'Team within selected timeframe': ['Future Coders Club'],
    'Successful defensive actions per 90': [6],
    'Progressive runs per 90': [58],
    'Successful dribbles per 90': [56],
    'Progressive passes per 90': [24],
    'Passes to final third per 90': [60],
    'Accurate progressive passes, %': [81],
    'Through passes per 90': [75],
    'xA per 90': [58],
    'xG per 90': [91],
    'Dangerous attacking actions per 90': [84]
}
...
# Call the plot_player function
fig = plot_player(df, 'Future Coder', '23/24', 'CM', 'Future Coders Club')
